...
<div class="row">
				...
				<tr>
					...
					<td>
						<div>
							...
							<a href="#" class="btn btn-default btn-xs edit-link" style="visibility: visible;" id="link-id-{{link.id}}">
								<span class="glyphicon glyphicon-edit"></span>
							</a>
							<a href="#" class="btn btn-default btn-xs delete-link" style="visibility: visible;" id="link-delid-{{link.id}}">
	...
	<div class="col-sm-2">
		<div class="sidebar-module sidebar-module-inset text-center">
			<a href="#" id="add-bookmark-link" class="btn btn-default">
				<span class="glyphicon glyphicon-link"></span>&nbsp;Nouveau<br />marque-page
			</a>
		</div>
		<div class="sidebar-module">
			...
			{% for tag in tags %}
				<a href="{% url 'bookmarks_links_tag' tag.name %}">
					{{tag.name}}
				</a>
			{% endfor %}
		</div>
		...
		<div class="sidebar-module">
			<h4>
				<span class="glyphicon glyphicon-hand-right"></span>&nbsp;Outils
			</h4>

			<a class="" href="javascript:(function(){window.open('{{share_link}}?u='+encodeURIComponent(window.location));})()" id="bookmarkme" title="{{share_title}}" rel="sidebar">
				Create bookmarklet
			</a>
		</div>
	</div>
