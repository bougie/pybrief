"""
Django settings for pybrief project.
...
SECRET_KEY = 'wyn=7a5hwqbgmeo$77*ed55+ze)9()1#vukx3%s*xfj#p)l+n&'
...
ROOT_URLCONF = 'pybrief.urls'

WSGI_APPLICATION = 'pybrief.wsgi.application'
